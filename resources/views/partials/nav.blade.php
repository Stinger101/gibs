...
<div class="col-md-4">
  <ul class="list-inline pull-right">
    <li class="gCofBrownBtn btn">
      @if (session()->has('cart'))
      <?php $id=array_keys(array_count_values(session('cart')));?>
      <a href="/cart/{{urlencode(serialize($id))}}" class=""> <i class="fa fa-shopping-basket"></i> Cart ~ {{sizeof(session('cart'))}}

    </a>


    @else
    <a href="/cart" class=""> <i class="fa fa-shopping-basket"></i> Cart ~ 0
